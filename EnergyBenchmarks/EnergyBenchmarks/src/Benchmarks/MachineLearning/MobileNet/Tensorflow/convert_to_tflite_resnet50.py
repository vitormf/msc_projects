...
with open('resnet50_labels.txt', 'w') as labels_file:
...
with open('keras_resnet50.tflite', 'wb') as file:
...
_TFLITE_MODEL_PATH = "keras_resnet50.tflite"
_LABELS_FILE = "resnet50_labels.txt"
_TFLITE_METADATA_MODEL_PATHS = "keras_resnet50_with_metadata.tflite"
